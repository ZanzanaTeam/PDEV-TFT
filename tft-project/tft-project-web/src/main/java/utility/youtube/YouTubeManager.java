...
public class YouTubeManager {
	...
	private static final String YOUTUBE_URL = "https://www.googleapis.com/youtube/v3/videos";
	...
	public List<YouTubeVideo> retrieveVideos(String textQuery, int maxResults, boolean filter, int timeout)
			throws Exception {

		YouTubeService service = new YouTubeService(clientID);
		service.setConnectTimeout(timeout); // milliseconds
